...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'hccheader.png')) {
		$tcpdf_header_logo = 'hccheader.png';
	}
...
if (!defined('PDF_HEADER_LOGO_WIDTH')) {
	if (!empty($tcpdf_header_logo)) {
		define ('PDF_HEADER_LOGO_WIDTH', 205);
	} else {
...
if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by MIS");
}
...
if (!defined('PDF_FONT_MONOSPACED')) {
	define ('PDF_FONT_MONOSPACED', 'verdana');
}
